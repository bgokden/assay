...
stage compiled-modernbert-large $COMPILED --encoder answerdotai/ModernBERT-large --data data/v4 --extra $GENERIC --out runs/compiled-modernbert-large --batch-size 16 || true
