...
set -euo pipefail
cd "$(dirname "$0")/.."
uv run python -m assay.data.distill --teacher runs/assay-27b --train data/v2/train.jsonl --out data/distill \
  --generic 40000 --policy-hard 5000 --dates 6000 --dev 300 --batch-size 8
mkdir -p data/v3
