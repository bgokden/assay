#!/usr/bin/env bash
# Scale the encoder-decoder tier if the instruction-tuned base size is worth scaling:
# t5gemma-l-l-ul2-it is 24 layers each side at hidden 1024 against the base model's 12 at 768.
# Runs after the -it queue, in the arrangement that trains best there.
#
